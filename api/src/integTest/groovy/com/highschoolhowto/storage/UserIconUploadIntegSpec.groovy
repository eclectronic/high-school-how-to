...
class UserIconUploadIntegSpec extends BaseIntegrationSpec {
    ...
    // A minimal valid 1x1 JPEG (same bytes as unit test — known to work with thumbnailator)
    ...
    def "upload valid JPEG returns iconUrl in media path"() {
        given:
        ...
        body.iconUrl == expectedUrl.toString()
        body.iconUrl.contains("media/icons/${user.id}".toString())
    }
