...
4. **Configure**:
   - **Name**: `My Big Sister Email App` (or preferred name)
...
3. **Description**: `Django Email Secret`
4. **Expires**: Select "24 months"
5. **Click**: "Add"
6. **⚠️ IMPORTANT**: Copy the secret value immediately (won't be shown again)
